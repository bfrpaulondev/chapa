...
const EXERCISE_VIDEOS: ExerciseVideo[] = [
  ...
  { match: /barra fixa|pull.?up/i, id: "eGo4IYlbE5g", title: "The Perfect Pull Up — Do It Right", source: "Calisthenicmovement" },
  ...
  { match: /rosca direta|barbell curl/i, id: "kwG2ipFRgfo", title: "How to Do a Barbell Curl", source: "Howcast" },
  { match: /rosca martelo|hammer curl/i, id: "zC3nLlEvin4", title: "How To: Dumbbell Hammer Curl", source: "ScottHermanFitness" },
  { match: /agachamento|barbell squat|squat/i, id: "ultWZbUMPL8", title: "The Back Squat", source: "CrossFit" },
